        ...
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-white/90 font-sans text-lg md:text-xl mb-8 leading-relaxed">
              Book a free 20-minute call. We'll audit your current online presence and show you exactly which parts of our strategy would have the biggest impact on your business.
            </p>
