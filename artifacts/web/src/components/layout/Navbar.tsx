      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              href="/get-started"
              className="cta-btn group bg-gradient-to-r from-[#2E7BB4] to-[#1a5a8a] text-white text-sm font-bold px-5 py-2.5 rounded-lg relative overflow-hidden transition-all duration-300 shadow-[0_2px_12px_rgba(46,123,180,0.3)] hover:shadow-[0_4px_20px_rgba(46,123,180,0.5)] hover:-translate-y-0.5"
            >
              Free Website Review
            </Link>
          </div>
